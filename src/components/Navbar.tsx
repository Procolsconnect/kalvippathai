  ...
  return (
    <header className="bg-card shadow-md sticky top-0 z-50 animate-slide-down">
      <nav className="max-w-[1400px] mx-auto px-5 py-4 flex justify-between items-center">
        ...
        <a
          href="#apply"
          className="hidden md:inline-block gradient-orange text-orange-foreground px-7 py-3 rounded-full font-bold font-body transition-all hover:-translate-y-0.5 shadow-lg hover:shadow-xl"
        >
          Apply Now
        </a>
